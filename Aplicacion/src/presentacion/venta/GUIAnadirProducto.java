							...
							try {
								...
								if(id >= 0 &&  unidades > 0 ){
									...
									if( tV != null){
										...
										guiVenta.update(Events.RES_AGREGAR_PRODUCTO_OK, tV);
									}
									else{
										guiVenta.update(Events.RES_AGREGAR_PRODUCTO_KO, -2 );
									}
								}
								else
									GUIVenta.getInstance().update(Events.RES_AGREGAR_PRODUCTO_KO, -1);
							} catch (Exception ex) {
